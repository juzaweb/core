...
use Juzaweb\Modules\Core\Permissions\Exceptions\WildcardPermissionInvalidArgument;
use Juzaweb\Modules\Core\Permissions\Guard;
use Juzaweb\Modules\Core\Permissions\PermissionRegistrar;
use Juzaweb\Modules\Core\Permissions\WildcardPermission;
...
trait HasPermissions
{
    ...
    public function permissions(): BelongsToMany
    {
        return $this->morphToMany(
            \Juzaweb\Modules\Core\Permissions\Models\Permission::class,
            'model',
