...
trait HasRoles
{
    ...
    public function roles(): BelongsToMany
    {
        return $this->morphToMany(
            \Juzaweb\Core\Models\Permissions\Role::class,
            'model',
            'model_has_roles',
            'model_id',
     ...
     * @param  int|array|\Juzaweb\Core\Permissions\Contracts\Role|string|\Illuminate\Support\Collection  $roles
     ...
     *
     * @param array|string|int|\Juzaweb\Core\Permissions\Contracts\Role|\Illuminate\Support\Collection ...$roles
     *
     * @return $this
     */
     ...
     *
     * @param string|int|\Juzaweb\Core\Permissions\Contracts\Role $role
     */
     ...
     *
     * @param  array|\Juzaweb\Core\Permissions\Contracts\Role|\Illuminate\Support\Collection|string|int  ...$roles
     *
     * @return $this
     */
     ...
     *
     * @param string|int|array|\Juzaweb\Core\Permissions\Contracts\Role|\Illuminate\Support\Collection $roles
     *
     * @return bool
     */
     ...
     *
     * @param  array|string|\Juzaweb\Core\Permissions\Contracts\Role|\Illuminate\Support\Collection  $roles
     * @param  string|null  $guard
     * @return bool
     */
