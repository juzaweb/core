...
namespace Juzaweb\Core\Permissions;
...
class PermissionRegistrar
{
    ...
    {
        $this->permissionClass = \Juzaweb\Core\Models\Permissions\Permission::class;
        $this->roleClass = \Juzaweb\Core\Models\Permissions\Role::class;
