...
use Juzaweb\Modules\Core\Permissions\Models\Group;
        ...
        Permission::insert(
            $permissions->map(function ($permission) {
                return [
                    ...
                    'guard_name' => $permission['guard_name'] ?? Guard::getDefaultName(config('auth.providers.users.model')),
                    ...
                    foreach ($permission as $item) {
                        if (!isset($permissions[$item])) {
                            $permissions[$item] = [
                                ...
                                'guard_name' => Guard::getDefaultName(config('auth.providers.users.model')),
