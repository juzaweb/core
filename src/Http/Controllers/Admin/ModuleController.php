...
class ModuleController extends AdminController
{
    public function __construct()
    {
        ...
        $this->middleware('permission:modules.edit')->only(['toggle', 'installFromZip', 'delete']);
    }
    ...
    public function delete(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return $this->success(
                __('core::translation.module_deleted_successfully', ['name' => $module])
            );
        } catch (\Exception $e) {
            return $this->error($e->getMessage());
        }
    ...
    public function installFromZip(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $destinationPath = Module::getModulePath($moduleName);
            ...
            File::moveDirectory($moduleDir, $destinationPath);
