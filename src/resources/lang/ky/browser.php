...
return [
    ...
    'invalid_disk' => 'Жараксыз диск',
    'error_folder_alnum' => 'Error folder alnum',
    'error_folder_exist' => 'Error folder exist',
];
