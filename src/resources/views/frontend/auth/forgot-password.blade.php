        ...
        <div class="card-body login-card-body">
            ...
            <form action="{{ route('forgot-password') }}" class="form-ajax" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="email" name="email" class="form-control" placeholder="{{ __('admin::translation.email') }}" required>
                ...
                <button type="submit" class="btn btn-primary btn-block">{{ __('admin::translation.forgot_password') }}</button>
