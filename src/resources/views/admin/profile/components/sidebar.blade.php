                ...
                <div class="profile-sidebar">
                    ...
                    <div class="profile-usermenu">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item {{ request()->is((config('core.admin_prefix') . 'profile/notification')) ? 'active' : '' }}">
                                <a class="nav-link"
                                   href="{{ admin_url('profile/notification') }}">
                                    <i class="fas fa-bell"></i> {{ __('core::translation.notification') }}
                                </a>
                            </li>
                        </ul>
                    </div>
