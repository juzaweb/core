...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/theme-editor.min.css') }}">
    <!--[if lt IE 9]>
    <script src="{{ asset('js/html5shiv.min.js') }}"></script>
    <script src="{{ asset('js/respond.min.js') }}"></script>
    <![endif]-->

    <script src="{{ mix('assets/js/theme-editor.min.js') }}"></script>
            ...
            <header class="te-top-bar">
                <div class="te-top-bar__list">
                    <div class="te-top-bar__item te-top-bar__item--fill">
                        <button class="ui-button btn--plain te-panel__header-action" onclick="window.location='{{ route('admin.themes.index', [$websiteId]) }}'">
